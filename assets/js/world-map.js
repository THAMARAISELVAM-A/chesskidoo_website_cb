...
(function () {
  ...
  const CENTRES = [
    { id: 'bhavani',    name: 'Bhavani (Laxmi Nagar)', flag: '🏫', tag: 'Head Office', lon: 77.6817, lat: 11.4453,
    ...
    panel.innerHTML =
      ...
      (m.mapUrl
        ? '<div style="display:flex;gap:8px;margin-top:auto;flex-wrap:wrap;">' +
            '<a href="' + m.mapUrl + '" target="_blank" rel="noopener" class="ckw-panel-cta" style="flex:1;text-align:center;text-decoration:none;display:inline-flex;align-items:center;justify-content:center;gap:6px;background:rgba(255,255,255,0.08);color:#fff;border:1px solid rgba(255,255,255,0.2);">' +
              '📍 View on Google Maps ↗' +
            '</a>' +
            '<button class="ckw-panel-cta" style="flex:1;" onclick="CK.openDemoModal()">Book Free Demo</button>' +
          '</div>'

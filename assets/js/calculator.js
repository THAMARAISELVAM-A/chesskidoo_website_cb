...
(function () {
  ...
  window.dragStartCalcIcon = function(e) {
    // If mouse event, ensure left click
    ...
    document.addEventListener('touchmove', dragMoveCalcIcon, {passive: false});
    document.addEventListener('touchend', dragEndCalcIcon);
    e.preventDefault();
  };
  ...
  function dragEndCalcIcon(e) {
    ...
    document.removeEventListener('touchmove', dragMoveCalcIcon);
    document.removeEventListener('touchend', dragEndCalcIcon);
  ...
  function initCalcIcon() {
    const btn = document.getElementById('calc-toggle-btn');
    if (btn) {
      btn.removeAttribute('onclick'); // prevent double click firing
      btn.removeEventListener('mousedown', dragStartCalcIcon);
      btn.addEventListener('mousedown', dragStartCalcIcon);
      
      // Support for touch devices
      btn.removeEventListener('touchstart', dragStartCalcIcon);
  ...
  if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', initCalcIcon);
  } else {
    initCalcIcon();
  }

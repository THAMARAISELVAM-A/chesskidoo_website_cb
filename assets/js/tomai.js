...
(function () {
  ...
  TOM.knightSVG = function (variant) {
    ...
    return `
      <svg viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" fill="${fill}">
        <path d="M410.7 274.5c22.1 41.3 22 93-.5 133.5H37.7C15.2 367.5 15 315.8 37.2 274.5c2.4-4.5 4.3-9.5 5.5-14.7l6.7-29.3C23.7 206 14.1 169 28.6 137.9c16.3-34.7 66.8-51 98.7-27.1l11.4 8.6c11.8 8.9 28.5 7.1 38.2-4.1l20.4-23.7c16.2-18.7 44.9-19 61.5-.5l5.2 5.8c22.3 25.1 27.6 61.3 13.9 92l-4.1 9.2c-5.7 12.8-5.3 27.3 .9 39.8l1.6 3.1c9.3 18.2 12 39 7.6 59.2l-.7 3.5c-1.3 5.4-3.4 10.5-6.2 15zM19 456c0-13.3 10.7-24 24-24h362c13.3 0 24 10.7 24 24s-10.7 24-24 24H43c-13.3 0-24-10.7-24-24z"/>
      </svg>`;
  };
